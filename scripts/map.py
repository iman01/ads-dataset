    ...
    def __init__(self, path, obstacles):
        ...
        for single_rectangle in obstacles:
            ...
            for each_corner in single_rectangle:
                single_rectangle_map.append([int(each_corner[0] / self.map_res) + 10,
                                             63 - int(each_corner[1] / self.map_res)])
        ...
        self.map_path = [[i + 10 for i in self.map_path[0]], [63 - i for i in self.map_path[1]]]  # shift to map
